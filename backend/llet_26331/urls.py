...
admin.site.site_header = "LLET"
admin.site.site_title = "LLET Admin Portal"
admin.site.index_title = "LLET Admin"

# swagger
api_info = openapi.Info(
    title="LLET API",
    default_version="v1",
    description="API documentation for LLET App",
)
